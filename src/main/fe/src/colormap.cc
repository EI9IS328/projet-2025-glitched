...
//
//  colormap.cc: colormap utilities implementation
//
//************************************************************************
...
static const RGB VIRIDIS_LUT[256] = {
...
// Classic Jet colormap from blue -> cyan -> green -> yellow -> red
static const RGB JET_LUT[256] = {
    ...
    {0, 116, 255}, {0, 120, 255}, {0, 124, 255}, {0, 128, 255}, {0, 132, 255},
    {0, 136, 255}, {0, 140, 255}, {0, 144, 255}, {0, 148, 255}, {0, 152, 255},
    {0, 156, 255}, {0, 160, 255}, {0, 164, 255}, {0, 168, 255}, {0, 172, 255},
    {0, 176, 255}, {0, 180, 255}, {0, 184, 255}, {0, 188, 255}, {0, 192, 255},
    {0, 196, 255}, {0, 200, 255}, {0, 204, 255}, {0, 208, 255}, {0, 212, 255},
    {0, 216, 255}, {0, 220, 255}, {0, 224, 255}, {0, 228, 255}, {0, 232, 255},
    {0, 236, 255}, {0, 240, 255}, {0, 244, 255}, {0, 248, 255}, {0, 252, 255},
    ...
    {120, 255, 135}, {124, 255, 131}, {128, 255, 128}, {132, 255, 124}, {136, 255, 120},
    {140, 255, 116}, {144, 255, 112}, {148, 255, 108}, {152, 255, 104}, {156, 255, 100},
    {160, 255, 96}, {164, 255, 92}, {168, 255, 88}, {172, 255, 84}, {176, 255, 80},
    {180, 255, 76}, {184, 255, 72}, {188, 255, 68}, {192, 255, 64}, {196, 255, 60},
    {200, 255, 56}, {204, 255, 52}, {208, 255, 48}, {212, 255, 44}, {216, 255, 40},
    {220, 255, 36}, {224, 255, 32}, {228, 255, 28}, {232, 255, 24}, {236, 255, 20},
    {240, 255, 16}, {244, 255, 12}, {248, 255, 8}, {252, 255, 4}, {255, 255, 0},
...
ColormapType colormapFromString(const std::string& name) {
  ...
  if (lower == "viridis") {
    ...
    return COLORMAP_JET;
  } else if (lower == "grayscale" || lower == "gray" || lower == "grey") {
...
RGB viridis(uint8_t value) {
  return VIRIDIS_LUT[value];
}

RGB jet(uint8_t value) {
  return JET_LUT[value];
}